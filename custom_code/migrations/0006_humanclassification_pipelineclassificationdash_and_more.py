# Generated by Django 4.2.30 on 2026-07-09 09:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tides_specid', models.BigIntegerField(blank=True, db_column='tides_specid', db_index=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tides_specid', models.BigIntegerField(blank=True, db_column='tides_specid', db_index=True, null=True, unique=True)),
                ('sn_type', models.CharField(blank=True, max_length=50, null=True)),
                ('probability', models.FloatField(blank=True, null=True)),
                ('version', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            name='TidesSpec',
            fields=[
                ('tides_specid', models.BigIntegerField(db_column='tides_specid', primary_key=True, serialize=False)),
                ('sn_type', models.CharField(blank=True, max_length=50, null=True)),
